  ...
  return (
    <div>
      <div style={{
        ...
        <h1> متابعه اداء العضو</h1>      </div>
      <div style={{ width: "fit-content" }}>
        <Link style={{ textDecoration: "none" }} to='../MemberPerformanceData'>
          <Button sx={{
            ...
            display: "block",
            marginBottom: "25px",
          }} className='addMember' variant="contained" >اضافه اداء للعضو</Button>
        </Link>
      </div>
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: "#dc1f27" }}>
              ...
              <TableCell sx={{ color: "#fff" }}>رقم الجلسه</TableCell>
              <TableCell sx={{ color: "#fff" }}>التاريخ</TableCell>
              <TableCell sx={{ color: "#fff" }}>حاله الحضور</TableCell>
              <TableCell sx={{ color: "#fff" }}> المرفقات</TableCell>
