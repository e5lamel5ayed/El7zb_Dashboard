  ...
  return (
    <div>
      <div style={{
        ...
        <h1> تسديد العضويه </h1>      </div>
      <div style={{ width: "fit-content" }}>
        <Link style={{ textDecoration: "none" }} to='/AddPayments'>
          <Button sx={{
            ...
            display: "block",
            marginBottom: "25px",
          }} className='addMember' variant="contained" > تسديد العضويه</Button>
        </Link>
      </div>
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: "#dc1f27" }}>
              ...
              <TableCell sx={{ color: "#fff" }}>نوع العضويه </TableCell>
              ...
              <TableCell sx={{ color: "#fff" }}> حاله العضويه </TableCell>
