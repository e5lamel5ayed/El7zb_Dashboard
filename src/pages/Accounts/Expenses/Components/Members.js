  ...
  return (
    <div>
      ...
      <div style={{ width: "fit-content" }}>
        <Link style={{ textDecoration: "none" }} to='/AddExpenses'>
          <Button sx={{
            ...
            display: "block",
            marginBottom: "25px",
          }} className='addMember' variant="contained" > اضافة مصروفات </Button>
        </Link>
      </div>
      ...
      <div style={{ marginBottom: "2%", display: "flex", justifyContent: "space-between" }}>
        <div className='d-flex'>
          ...
          <input class="col-md-3 mr-sm-2 search-edit" type="search" placeholder="اسم المنصرف اليه " aria-label="Search" />
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: "#dc1f27" }}>
              ...
              <TableCell sx={{ color: "#fff" }}> اسم المنصرف اليه </TableCell>
              ...
              <TableCell sx={{ color: "#fff" }}>نوع البند </TableCell>
